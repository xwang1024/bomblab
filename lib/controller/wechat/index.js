...
var debug = require('debug')('Pabao:controllers:index');
...
exports.wechatValidation = function (req, res, next) {
  const validateSignature = require('../../service/util').validateSignature;

  let signature = req.query.signature;
  let timestamp = req.query.timestamp;
  let nonce = req.query.nonce;
  let echostr = req.query.echostr;
  debug('signature %s, timestamp %s, nonce %s, echostr %s', signature, timestamp, nonce, echostr);

  let flag = validateSignature(signature, timestamp, nonce);
