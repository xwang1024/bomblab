...
module.exports = exports = function () {
  ...
  // 关注回复管理
  router.all('/admin/subcribeReply', require('../controller/admin/subcribeReply/view').index);
  ...
  router.get('/api/admin/replyQueue/:id', require('../controller/admin/replyQueue/api').get);
