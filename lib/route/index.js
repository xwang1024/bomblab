...
module.exports = exports = function () {
  ...
  // 邀请卡管理
  router.all('/admin/invitationCard', require('../controller/admin/invitationCard/view').index);
  router.all('/admin/invitationCard/settings', require('../controller/admin/invitationCard/view').settings);
  ...
  // 系统配置
  router.get('/api/admin/setting/:key', require('../controller/admin/setting/api').get);
  router.put('/api/admin/setting/:key', require('../controller/admin/setting/api').put);
