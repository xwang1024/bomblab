...
module.exports = exports = function () {
  ...
  router.get('/api/admin/clearQuota', require('../controller/admin/api').clearQuota);

  // 微信
  router.get('/api/wechat/access', require('../controller/wechat/index').wechatValidation);
  router.post('/api/wechat/access', require('../controller/wechat/filter').preventDuplicate);
  ...
  // 邀请任务管理
  router.all('/admin/invitationTask', require('../controller/admin/invitationTask/view').index);
  router.all('/admin/invitationTask/create', require('../controller/admin/invitationTask/view').create);
  router.all('/admin/invitationTask/modify/:id', require('../controller/admin/invitationTask/view').modify);
  router.all('/admin/invitationTask/cardList/:id', require('../controller/admin/invitationTask/view').cardList);
  // router.all('/admin/invitationTask/settings', require('../controller/admin/invitationTask/view').settings);
  ...
  // 邀请任务管理
  router.get('/api/admin/invitationTask', require('../controller/admin/invitationTask/api').get);
  router.post('/api/admin/invitationTask', require('../controller/admin/invitationTask/api').post);
  router.get('/api/admin/invitationTask/:id', require('../controller/admin/invitationTask/api').getById);
  router.put('/api/admin/invitationTask/:id', require('../controller/admin/invitationTask/api').put);
  router.delete('/api/admin/invitationTask/:id', require('../controller/admin/invitationTask/api').delete);
