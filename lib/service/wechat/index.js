...
function redirectURL(url) {
  ...
  return 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appid + '&redirect_uri=' + encodeURI(url) + '&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
}
